...
void HelpCmd()
{
	...
	printf(" re: Redraw this page\n");
	printf(" b: Move to the before page\n");
	printf(" n: Move to the next page\n");
	printf(" page [index]: Move to [index] page\n");
	printf(" list: View page list\n");
	printf(" new: Initialize this page\n");
	printf(" copy [index]: Copy from [index] page\n");
	...
	printf(" w [index]: Overwrite to [index] step from STP7\n");
	printf(" i: Insert to STP0 from STP7\n");
	printf(" i [index]: Insert to [index] step from STP7\n");
	printf(" m [index] [index2]: Move to [index2] step from [index] step\n");
	printf(" d [index]: Delete [index] step\n");
	printf(" on/off: Torque On/Off all motor\n");
	printf(" on/off [id] [id2] ...: Torque On/Off only [id] [id2]...\n");
	printf("\n");
